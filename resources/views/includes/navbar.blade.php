    <nav class="navbar navbar-expand-lg navbar-light navbar-store fixed-top navbar-fixed-top" data-aos="fade-down">
      <div class="container">
        <a href="{{ route('home') }}" class="navbar-brand">
          <img src="/assets/images/logo.svg" alt="Logo Toko" />
        </a>
          ...
          @auth
            ...
            <ul class="navbar-nav d-none d-lg-flex">
              <li class="nav-item dropdown">
                <a href="#" class="nav-link" id="navbarDropwodn" role="button" data-toggle="dropdown">
                  @if (Auth::user()->roles === 'ADMIN')
                    <img src="https://i.pinimg.com/736x/0d/dc/14/0ddc1459fb0dd097eb537a69910affea.jpg" alt=""
                      class="rounded-circle mr-2 profile-picture" />
                  @else
                    <img src="/assets/images/icon-user.png" alt="" class="rounded-circle mr-2 profile-picture" />
                  @endif
                  Hi, {{ Auth::user()->name }}
                </a>
            ...
            <ul class="navbar-nav d-block d-lg-none">
              ...
              <li class="nav-item">
                <a href="{{ route('cart') }}" class="nav-link d-block"> Cart </a>
              </li>
            </ul>
          @endauth
        </div>
