                ...
                <div class="row mt-4">
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-product d-block">
                      <div class="card-body">
                        <img src="/assets/images/product-card-1.png" alt="" class="w-100 mb-2">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-products d-block">
                      <div class="card-body">
                        <img src="/assets/images/product-card-2.png" alt="" class="w-100 mb-2">
                        <div class="product-title">Shirup Marzzan</div>
                        <div class="product-category">Foods</div>
                      </div>
                    </a>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-products d-block">
                      <div class="card-body">
                        <img src="/assets/images/product-card-3.png" alt="" class="w-100 mb-2">
                        <div class="product-title">Shirup Marzzan</div>
                        <div class="product-category">Foods</div>
                      </div>
                    </a>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <a href="/dashboard-products-details.html" class="card card-dashboard-products d-block">
                      <div class="card-body">
                        <img src="/assets/images/product-card-4.png" alt="" class="w-100 mb-2">
                        <div class="product-title">Shirup Marzzan</div>
                        <div class="product-category">Foods</div>
                      </div>
                    </a>
