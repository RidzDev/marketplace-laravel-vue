          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              <div class="price">${{ number_format($product->price) }}
                <div class="text-muted" style="text-decoration: line-through; font-size: 14px">
                  ${{ number_format($product->price + 10) }}.99<span
                    style="display: inline-block;background-color: rgba(255, 0, 0, 0.1); color: red;margin-left: .5rem; padding: 2px 5px 2.1px 5px; border-radius: 3px; ">OFF</span>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-12 col-lg-8">
              <ul class="list-unstyled">
                <li class="media">
                  <img src="/assets/images/icon-testimonial-1.png" class="mr-3 rounded-circle" alt="" />
                ...
                <li class="media">
                  <img src="/assets/images/icon-testimonial-2.png" class="mr-3 rounded-circle" alt="" />
                  <div class="media-body">
                ...
                <li class="media">
                  <img src="/assets/images/icon-testimonial-3.png" class="mr-3 rounded-circle" alt="" />
                  <div class="media-body">
