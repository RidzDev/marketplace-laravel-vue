    ...
    <div class="d-flex" id="wrapper" data-aos="fade-right">
      ...
      <div class="border-right" id="sidebar-wrapper">
        <div class="sidebar-heading text-center">
          <img src="/assets/images/avatar.png" alt="" class="my-4" style="width: 125px" />
        </div>
        <div class="list-group list-group-flush">
          ...
          <a href="{{ route('product-gallery.index') }}"
            ...
            class="list-group-item list-group-item-action">Galleries</a>
          ...
          <a href="/" class="list-group-item list-group-item-action d-none d-lg-inline-block">Home</a>
        </div>
      </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav d-none d-lg-flex ml-auto">
                <li class="nav-item">
                  ...
                  <a href="{{ route('dashboard-admin') }}" class="nav-link" role="button">
                    {{-- <a
                      href="#"
                      class="nav-link"
                      id="navbarDropdown"
              ...
              <ul class="navbar-nav d-block d-lg-none">
                <li class="nav-item">
                  <a href="/admin/dashboard" class="nav-link"> Hi, Admin </a>
                </li>
